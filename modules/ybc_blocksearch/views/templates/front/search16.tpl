...
{capture name=path}{if isset($title_page) && $title_page}{$title_page|escape:'html':'UTF-8'}{else}{l s='Search result' mod='ybc_blocksearch'}{/if}{/capture}
<h1 class="page-heading product-listing">
    {if isset($title_page) && $title_page}{$title_page|escape:'html':'UTF-8'}{else}{l s='Search results for' mod='ybc_blocksearch'}{/if} <span class="key_search">{$keyWord|escape:'html':'UTF-8'}</span>
</h1>
<div id="content-wrapper">
    <div class="wrap_search">
        {if isset($no_type) && $no_type}
            <div class="status">
                <h4>{$status|escape:'html':'UTF-8'}</h4>
            </div>
        {/if}
        {if isset($data) && !$data}
